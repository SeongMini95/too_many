...
public class ReviewListResponseDto {
    ...
    public static class ReviewResponseDto {
        ...
        public ReviewResponseDto(Review review) {
            ...
            this.images = review.getReviewImages().stream().map(ReviewImage::getImageUrl).collect(Collectors.toSet());
            this.recommends = review.getReviewRecommends().stream().map(v -> v.getRecommendType().getCode()).collect(Collectors.toSet());
